...
const Home = () => {
    const { isLoadingProfile, getUserProfiles, userProfiles, subscribeToNewMatches, unsubscribeFromNewMatches } = useMatchStore()
    ...
    return (
        <div className='flex flex-col lg:flex min-h-screen bg-gradient-to-br from-pink-100 to-purple-100 overflow-hidden'>
            <Sidebar />
            <div className='flex-grow flex flex-col overflow-hidden'>
                ...
                <main className='flex-grow flex flex-col gap-10 justify-center items-center p-4 relative overflow-hidden'>
                    ...
                    {userProfiles.length === 0 && !isLoadingProfile && <NoMoreProfiles />}
